...
for ((i=1; i<=RUNS; i++)); do
    ...
    # Izpišemo celoten output programa v log (da imamo zabeležene energije)
    echo "$program_output"
...
# Izračun povprečja (seštejemo vse argumente v nizu ALL_TIMES in delimo s številom argumentov NF)
